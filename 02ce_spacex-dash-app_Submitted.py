...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        filtered_df_counts = filtered_df['class'].value_counts().sort_index().reset_index()
        filtered_df_counts.columns = ['class', 'counts']
...
def get_scatter_chart(entered_site, payload_range):
    filtered_df = spacex_df[spacex_df['Payload Mass (kg)'].between(*payload_range, inclusive='both')]
